...
(function (factory) {
  ...
  const camelCase = (function () {
    ...
    return function (str) {
      return str
        .replace(camelRegex, (letter, index) =>
  ...
  function encode(name, value) {
    return `&${encodeURIComponent(name)}=${encodeURIComponent(value).replace(
      /%20/g,
      '+'
    )}`;
  }
  ...
  function insertContent(parent, child, prepend) {
    ...
    each(
      ...
      str
        ? (v) =>
            v.insertAdjacentHTML(prepend ? 'afterbegin' : 'beforeend', child)
        : (v, i) =>
            insertElement(v, i === 0 ? child : child.cloneNode(true), prepend)
    );
  }
...
$jscomp.arrayIterator = function (e) {
  ...
  return $jscomp.iteratorPrototype(() =>
    r < e.length ? { done: !1, value: e[r++] } : { done: !0 }
  );
};
...
(function (r) {
  ...
  function ba(a, c) {
    ...
    for (b in a) {
      let f = I(a[b], c);
      h.arr(f) && ((f = f.map((a) => I(a, c))), f.length === 1 && (f = f[0]));
      d[b] = f;
    }
  ...
  function q(a) {
    function c() {
      return window.Promise && new Promise((a) => (p = a));
    }
    function d(a) {
    ...
    return function (c, d, b, f) {
      if (c >= 0 && c <= 1 && b >= 0 && b <= 1) {
        ...
        return function (k) {
          ...
          let n =
            3 * (1 - 3 * b + 3 * c) * l * l + 2 * (3 * b - 6 * c) * l + 3 * c;
          if (n >= 0.001) {
            for (h = 0; h < 4; ++h) {
              n =
                3 * (1 - 3 * b + 3 * c) * l * l +
          ...
          value: function _handleDropdownKeydown(e) {
            ...
            if (letter && nonLetters.indexOf(e.which) === -1) {
              ...
              const newOptionEl = $(this.dropdownEl)
                .find('li')
                .filter(
                  (el) => $(el).text().toLowerCase().indexOf(string) === 0
                )[0];
      ...
      [
        ...
        },
        {
          ...
          value: function _handleWindowResize() {
            ...
            if (this.tabWidth !== 0 && this.tabsWidth !== 0) {
              ...
              this._indicator.style.right = `${this._calcRightPos(
                this.$activeTabLink
              )}px`;
            }
          },
        ...
        },
        {
          ...
          value: function _createIndicator() {
            ...
            setTimeout(() => {
              _this24._indicator.style.left = `${_this24._calcLeftPos(
                _this24.$activeTabLink
              )}px`;
              _this24._indicator.style.right = `${_this24._calcRightPos(
                _this24.$activeTabLink
              )}px`;
            }, 0);
          },
      ...
      [
        ...
        },
        {
          ...
          value: function _repositionWithinScreen(x, y, width, height) {
            ...
            const edges = M.checkWithinContainer(
              document.body,
              bounding,
              offset
            );
      ...
      [
        ...
        },
        {
          ...
          value: function renderRow(days, isRTL, isRowSelected) {
            ...
            }">${(isRTL ? days.reverse() : days).join('')}</tr>`;
          },
        },
        {
          key: 'renderTable',
          value: function renderTable(opts, data, randId) {
            return `<div class="datepicker-table-wrapper"><table cellpadding="0" cellspacing="0" class="datepicker-table" role="grid" aria-labelledby="${randId}">${this.renderHead(
              opts
            )}${this.renderBody(data)}</table></div>`;
          },
        },
        {
          key: 'renderHead',
          value: function renderHead(opts) {
            ...
            return `<thead><tr>${(opts.isRTL ? arr.reverse() : arr).join(
              ''
            )}</tr></thead>`;
          },
        },
        ...
        },
        {
          ...
          value: function renderTitle(
            ...
            let html = `<div id="${randId}" class="datepicker-controls" role="heading" aria-live="assertive">`;
            ...
            monthHtml = `<select class="datepicker-select orig-select-month" tabindex="-1">${arr.join(
              ''
            )}</select>`;
        ...
        },
        {
          ...
          value: function draw(force) {
            ...
            randId = `datepicker-title-${Math.random()
              .toString(36)
              .replace(/[^a-z]+/g, '')
              .substr(0, 2)}`;
          ...
          value: function _pickerSetup() {
            ...
            $(
              `<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="${
                this.options.twelveHour ? '3' : '1'
              }">${this.options.i18n.cancel}</button>`
            )
          ...
          value: function _scroll(x) {
            ...
            for (i = 1; i <= half; ++i) {
              ...
              if (!this.noWrap || this.center + i < this.count) {
                ...
                const _transformString = `${alignment} translateX(${
              ...
              if (!this.noWrap || this.center - i >= 0) {
                el = this.images[this._wrap(this.center - i)];
                const _transformString2 = `${alignment} translateX(${
                  -this.options.shift + (-this.dim * i - delta) / 2
                }px) translateZ(${zTranslation}px)`;
                this._updateItemStyle(
                  el,
            ...
            if (
              ...
              el = this.images[this._wrap(this.center)];
              const _transformString3 = `${alignment} translateX(${
                -delta / 2
              }px) translateX(${
              ...
              this.$selectOptions.each((el) => {
                if ($(el).is('option')) {
                  ...
                  $(_this71.dropdownOptions).append(
                    $(
                      `<li class="optgroup"><span>${el.getAttribute(
                        'label'
                      )}</span></li>`
                    )[0]
                  );
